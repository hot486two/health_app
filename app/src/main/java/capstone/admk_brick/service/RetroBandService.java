package capstone.admk_brick.service;
...
import capstone.admk_brick.bluetooth.BluetoothManager;
import capstone.admk_brick.bluetooth.ConnectionInfo;
import capstone.admk_brick.bluetooth.TransactionBuilder;
import capstone.admk_brick.bluetooth.TransactionReceiver;
...
import capstone.admk_brick.contents.IContentManagerListener;
...
public class RetroBandService extends Service implements IContentManagerListener {
    ...
    public void onCreate() {
        ...
        mContext = getApplicationContext();			//API - Context - Method-어플리케이션 종료후에도 활동 가능한 글로벌한 application의 context
        initialize();
    }
    ...
    private void initialize() {
        ...
        AppSettings.initializeAppSettings(mContext);		//make class - import utils.AppSettings - method -for getting prior data(today_step, weight)
    ...
    public void finalizeService() {
        ...
        mContentManager.saveCurrentActivityReport();		//ContectManager.java 's Object mContentManager -> method ->Save sum of calorie cache to DB
